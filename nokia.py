...
class NokiaLogic(object):
    ...
    def _nextStep(self, operation="skip"):
        ...
        op = operation
        if ( ( (op == "yes") and (gname != "Text_connectors") and (gname != "3DText") ) and  (operation == "yes") or (operation == "skip") ):
                ...
                if self.current_id > 100:
                    ...
                    if self.lock == False:
                        ...
                        if(operation=="yes"):
                            ...
                            pass
                        if((sid==1 and (self.current_id in (4,8,9))) or (sid==2 and (self.current_id in (5, 6))) or (sid==3 and (self.current_id in (2,5,6,9))) or (sid==4 and (self.current_id == 4))):
